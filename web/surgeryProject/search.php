<?php
   ...
   if(!isset($_SESSION['loggedin'])){
      $_SESSION['returnpage'] = 'search.php';
...
<body>
   ...
   <main>
      <form>
         ...
         <input type="text" id='surgeryDate' name='surgeryDate' placeholder='YYYY-M-DD'> <span class='hide' id='error1'>Surgery date is required</span><br>
